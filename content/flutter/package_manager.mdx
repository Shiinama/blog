---
title: 1.flutter 包管理 资源管理
description: flutter 包管理 资源管理
published: true
toc:
  visible: true
date: 2024-2-19
...
![image.png](https://ik.imagekit.io/leiakito/in-five-months-4k/Flutter/Untitled.png?updatedAt=1739986126304)
...
每次热更新时，`build`方法都会被执行

![image.png](https://ik.imagekit.io/leiakito/in-five-months-4k/Flutter/Untitled%201.png?updatedAt=1739986126227)
