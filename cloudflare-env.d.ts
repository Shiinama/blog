/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 89ea14615096bd53e6720a8dc718b328)
// Runtime types generated with workerd@1.20260625.1 2025-04-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	BLOG_BUCKET: R2Bucket;
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	BLOG_DATABASE: D1Database;
	AI_DAILY_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "AUTH_RESEND_KEY" | "AUTH_TRUST_HOST" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "PROJECT_NAME" | "DATABASE_NAME" | "DATABASE_ID" | "CONTENT_SIGNALS_API_KEY" | "NEXT_PUBLIC_BASE_URL" | "NEXT_PUBLIC_ADMIN_ID" | "NEXT_PUBLIC_R2_DOMAIN" | "SOCHEAP_BASE_URL" | "SOCHEAP_OPENAI_KEY" | "APIFY_API_TOKEN" | "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY" | "APIFY_TOKEN">> {}
}
