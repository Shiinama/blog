...
declare const messages: {
  "about": {
    "title": "Felix",
    "intro": "Software Engineer\nEnjoy the present, do interesting things.",
    "sections": {
      "experiences": {
        "title": "Experiences",
        "content": "- Craveu Co-founder & CTO: Built a network of hundreds of thousands of independent agentic personas, developed an in-house high-concurrency contextual memory engine, and led SEO growth to more than one million organic users within six months.\n- MyShell App Lead: Led the mobile product from 0 to 1 for MyShell App, positioned against Character.ai, worked deeply on core in-house multimodal audio technology, and helped the team secure $8 million in early funding.\n- Core Member of Midjourney's Founding Team: One of the earliest AIGC developers, involved in the early build-out of a global AI super app from 0 to 1."
      },
      "connect": {
        "title": "Open to Connect",
        "content": "If you're working on products, startups, growth, monetization, or making money, feel free to reach out."
      }
    },
  ...
  "admin": {
    ...
    "form": {
      ...
      "publishModal": {
        ...
        "description": "Double-check the metadata, cover image, and summary before going live.",
  ...
  "auth": {
    "login": {
      "page": {
        "title": "Welcome to Fish Blog",
        "description": "Sign in to keep reading and managing content"
      },
  ...
  "comments": {
    ...
    "placeholder": "Share your take or ask a question...",
    "signin": "Sign in to comment",
    "emptyError": "Write a few words before sending.",
    "submitError": "Could not post comment. Please try again.",
    "submit": "Post",
    "loading": "Loading comments...",
    "empty": "No comments yet. Be the first to add one.",
    "loadError": "Unable to load comments right now.",
    "anonymous": "Someone"
  },
  "explorer": {
    "searchLabel": "Search",
  ...
  "pwa": {
    ...
    "description": "Add Fish Blog to your home screen for faster, offline-friendly reading.",
    "cta": "Install",
  ...
  "home": {
    ...
    "heroKicker": "Mobile-first · Offline-ready",
    "heroTitle": "Practical notes on engineering, AI, and product",
    "heroDescription": "Long form walkthroughs, playbooks, and debriefs. Filter below to jump to what you need.",
    "rssCta": "Subscribe via RSS",
    "rssHint": "Add to your reader to catch new drops automatically.",
    "pwaHint": "Add Fish Blog to your home screen for quick, offline-friendly reading."
  },
  "seo": {
    "siteTitle": "Fish Blog",
    ...
    "aboutTitle": "Felix",
    "aboutDescription": "Software Engineer focused on AI products, growth, and monetization."
  }
};
